...
Places worth knowing about that are not this site: where people who *use*
plugins talk about them, and where people who *write* them find the specs,
frameworks and tools.

Links, not copies. Nothing on this page is harvested into the catalogue — these
sites' content is theirs, and the whole point of a link is that you arrive at
the thing rather than at somebody's summary of it. A link here is not an
endorsement, and nothing on this page is paid for.

Seeded by hand and certainly incomplete. If something is missing, or a link has
rotted, [say so](/about/contact).
