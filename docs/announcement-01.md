...
[Plugin Universe](https://plugin-universe.com/) is an searchable catalogue of plugins. It contains [Linked Open Data](https://en.wikipedia.org/wiki/Linked_data) that is machine-readable by various means (see [Services](https://plugin-universe.com/services)). 
